...
const endpointV1 = process.env.PERSONAL_TOKEN
  ? `${process.env.API_URL}/graphql/v1?personalToken=${process.env.PERSONAL_TOKEN}`
  : `${process.env.API_URL}/graphql/v1/${process.env.API_KEY}`;
